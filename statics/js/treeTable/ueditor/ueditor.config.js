...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        ,catcherUrl:URL+"../../../index.php?g=Asset&m=Ueditor&a=get_remote_image"
        ...
        //word转存配置区
        ,wordImageUrl:URL+"../../../index.php?g=Asset&m=Ueditor&a=uploadimg"            //word转存提交地址
        ,wordImagePath:""                       //
       ...
       ,filterTxtRules: function(){
           ...
           return {
               ...
               'p': function(node){
                    ...
                    var text = node.innerText().replace(re, "");
