                    ...
                    <div class="tab-pane active">
                        <form class="company form-horizontal"  ng-submit="companySubmit($event)"  ng-controller="companyCtl" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php if(empty($companyForm['code_pic'])): ?><img src="http://wangsong.com/statics/images/headicon_128.png" class="headicon"/>
                                    <?php else: ?>
                                        <img src="http://wangsong.com/data/upload/company/<?php echo ($companyForm["code_pic"]); ?>" class="headicon"/><?php endif; ?>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <?php if(empty($companyForm['group_pic'])): ?><img src="http://wangsong.com/statics/images/headicon_128.png" class="headicon"/>
                                    <?php else: ?>
                                        <img src="http://wangsong.com/data/upload/company/<?php echo ($companyForm["group_pic"]); ?>" class="headicon"/><?php endif; ?>
