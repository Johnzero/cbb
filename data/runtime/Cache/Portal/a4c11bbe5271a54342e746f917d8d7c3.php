...
<div class="navbar navbar-menu headroom" style="min-width:1170px !important;margin:0 auto">
	<div class="menu">
		<div class="menu-section">
			<a href="http://ahwenhui.com"><i class="fa fa-home" style="font-size: 35px;margin-top: 2px;"></i>首页</a>
		</div>

		<div class="menu-section">
			<a href="<?php echo u('list/index',array('id'=>3));?>" class="gesp">
			<img src="http://ahwenhui.com/statics/images/dszx.png" width="30" style="margin-top: 15px;"><br/>
			电商资讯</a>
			<ul class="sub-menu">
		...
		<div class="menu-section">
			<a class="gesp">
			<img src="http://ahwenhui.com/statics/images/whcy.png" width="20" style="margin-top: 14px;"><br/>文化产业</a>
			<ul class="sub-menu">
		...
		<div class="menu-section">
			<a class="gesp"><img src="http://ahwenhui.com/statics/images/lmkj.png" width="25" style="margin-top: 12px;"><br/>联盟空间</a>
			<ul class="sub-menu">
