				...
				<div class="table_full">
					<table width="100%" cellpadding="2" cellspacing="2">
						...
						<tr>
							<th width="80">来源 </th>
							<td>
								<input type="text" style="width:400px;" name="post[post_source]" value="" class="input input_hd J_title_color" placeholder="请输入来源"/>
							</td>
						</tr>
						<tr>
							<th width="80">作者 </th>
							<td>
								<input type="text" style="width:400px;" name="post[post_authorname]" class="input input_hd J_title_color" placeholder="请输入作者" />
							</td>
						</tr>
						<tr>
							<th width="80">关键词</th>
