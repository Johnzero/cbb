...
<head>
	...
	<link href="http://ciec.anhuinews.com/statics/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css" rel="stylesheet">
    <link href="http://ciec.anhuinews.com/statics/css/simplebootadmin.css" rel="stylesheet">
    <link href="http://ciec.anhuinews.com/statics/js/artDialog/skins/default.css" rel="stylesheet" />
    <link href="http://ciec.anhuinews.com/statics/font-awesome/css/font-awesome.min.css"  rel="stylesheet" type="text/css">
    <style>
		.length_3{width: 180px;}
	</style>
	<!--[if IE 7]>
	<link rel="stylesheet" href="http://ciec.anhuinews.com/statics/font-awesome/css/font-awesome-ie7.min.css">
	<![endif]-->
<script type="text/javascript">
//全局变量
var GV = {
    DIMAUB: "http://ciec.anhuinews.com/",
    JS_ROOT: "statics/js/",
    TOKEN: ""
};
</script>
<!-- Le javascript
    ...
    <script src="http://ciec.anhuinews.com/statics/js/jquery.js"></script>
    <script src="http://ciec.anhuinews.com/statics/js/jquery-migrate-1.2.1.js"></script>
    <script src="http://ciec.anhuinews.com/statics/js/wind.js"></script>
    <script src="http://ciec.anhuinews.com/statics/bootstrap/js/bootstrap.min.js"></script>
<?php if(APP_DEBUG): ?><style>
	...
	<style type="text/css">
		...
		.list-dot li a.close,.list-dot-othors li a.close{ background: url("http://ciec.anhuinews.com/statics/images/cross.png") no-repeat left 3px; display:block; width:16px; height:16px;position: absolute;outline:none;right:5px; bottom:5px}
						...
						<tr>
							<td>
								...
								<a href='javascript:void(0);' onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
									...
									<?php if(empty($smeta['thumb'])): ?><img src="http://ciec.anhuinews.com/statics/images/icon/upload-pic.png" id='thumb_preview' width='135' height='113' style='cursor:hand' />
									<?php else: ?>
								...
								<input type="button"  class="btn" onclick="$('#thumb_preview').attr('src','http://ciec.anhuinews.com/statics/images/icon/upload-pic.png');$('#thumb').val('');return false;" value="取消图片">
							</div>
						</td>
					</tr>
					<tr>
			...
			<div class="table_full">
				<table width="100%"  cellpadding="2" cellspacing="2">
					...
					<tr>
						...
						<script type="text/javascript"  src="http://ciec.anhuinews.com/statics/js/ueditor/ueditor.config.js"></script>
						<script type="text/javascript"  src="http://ciec.anhuinews.com/statics/js/ueditor/ueditor.all.min.js"></script>
					</td>
				</tr>
				<tr>
					<th width="80">相册图集 </th>
						...
						<fieldset class="blue pad-10">
							...
							<ul id="photos" class="picList">
								<?php if(is_array($smeta['photo'])): foreach($smeta['photo'] as $key=>$vo): ?><li id="savedimage<?php echo ($key); ?>">
									<input type="text" name="photos_url[]" value="http://ciec.anhuinews.com/data/upload/<?php echo ($vo['url']); ?>" title='双击查看' style="width:310px;" ondblclick="image_priview(this.value);" class="input">
...
<script type="text/javascript" src="http://ciec.anhuinews.com/statics/js/common.js"></script>
<script type="text/javascript" src="http://ciec.anhuinews.com/statics/js/content_addtop.js"></script>
<script type="text/javascript">
$(function () {
