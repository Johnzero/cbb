...
<div class="wrap J_check_wrap">
  <ul class="nav nav-tabs">
     <li><a href="<?php echo U('Page/index');?>">所有页面</a></li>
     <li><a href="<?php echo U('Page/add');?>">添加页面</a></li>
     <li class="active"><a href="#">页面编辑</a></li>
  </ul>
  <form name="myform" id="myform" action="<?php echo u('Portal/AdminPage/edit_post');?>" method="post" class="form-horizontal J_ajaxForms" enctype="multipart/form-data">
  <div class="col-right">
    <div class="table_full">
      <table width="100%"  cellpadding="2" cellspacing="2">
        ...
        <tr>
          <td><input type="text" name="post[post_modified]" id="updatetime" value="<?php echo ($post["post_modified"]); ?>" size="21" class="input length_3 J_datetime "></td>
        </tr>
        <tr>
          <td><b>状态</b></td>
        </tr>
