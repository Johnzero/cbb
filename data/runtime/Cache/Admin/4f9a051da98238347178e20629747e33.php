...
<![endif]-->
<link rel="stylesheet" href="http://wangsong.com/statics/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="http://wangsong.com/statics/css/simplebootadminindex-ie.css" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<div class="pull-left nav_shortcuts" >
					...
					<a class="btn btn-small btn-warning" href="http://wangsong.com/" title="前台首页" target="_blank">
				...
				<ul class="nav simplewind-nav pull-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="http://wangsong.com/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
	...
	<script src="http://wangsong.com/tpl/admin/assets/js/index.js"></script>
